...
const Header = () => {
  ...
  return (
    <header className="w-full h-20 flex items-center justify-between px-4 sm:px-6 border-b border-gray-700">
      <img
        src="logo.png"
        alt="reel-hub-logo"
      ...
      <div className="relative flex justify-center">
        ...
        <div className={`${history.length > 0 ? 'flex' : 'hidden'} absolute md:w-[290px] h-52 rounded bg-slate-800 flex-col top-12 md:top-[2.75rem] py-2 px-2 shadow-lg gap-y-1 max-md:hidden`}>
           <span className='text-[0.65rem] text-slate-200 text-end '>Recent searched</span>
